...
<!-- Barra lateral -->
<div class="row">
    <div class="barra-lateral col-7 col-md-6 col-lg-12">
...
<div class="contenedor-perfil">
    <div class="row align-items-center justify-content-center" style="width: 1000px">
        <div class="perfil m-2 m-md-3 col-7 col-md-6 col-lg-12">
            <div class="foto">
