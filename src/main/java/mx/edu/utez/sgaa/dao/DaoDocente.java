...
public class DaoDocente {
    ...
    public int RegistrarDocente(Docente docente) throws ClassNotFoundException {
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD)) {
                ...
                preparedStatement.setInt(6, docente.getEstatus());
    ...
    public boolean actualizarDocente(Docente docente) {
        String UPDATE_SQL = "UPDATE docentes SET nombre = ?, apellido = ?, correoElectronico = ?, estatus = ?, admission = ? WHERE matricula = ?;";
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD)) {
                ...
                preparedStatement.setInt(4, docente.getEstatus());
                preparedStatement.setBoolean(5, docente.isAdmission());
                preparedStatement.setString(6, docente.getMatricula());
    ...
    public Docente getDocenteByMatricula(String matricula) {
        ...
        String sql = "SELECT matricula, nombre, apellido, correoElectronico, estatus, admission FROM docentes WHERE matricula = ?";
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD);
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                if (rs.next()) {
                    ...
                    docente.setEstatus(rs.getInt("estatus"));
                    docente.setAdmission(rs.getBoolean("admission"));
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public boolean desactivarDocente(String matricula) {
        ...
        String sqlUpdate = "UPDATE docentes SET estatus = 0 WHERE matricula = ?";
    ...
    public boolean activarDocente(String matricula) {
        String sqlSelect = "SELECT estatus FROM docentes WHERE matricula = ?";
        String sqlUpdate = "UPDATE docentes SET estatus = 1 WHERE matricula = ?";
    ...
    public List<Docente> listarDocentes() {
        ...
        String sql = "SELECT idDocente, matricula, nombre, apellido, correoElectronico, estatus, admission FROM docentes where admission = true";
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD);
             PreparedStatement stmt = connection.prepareStatement(sql);
