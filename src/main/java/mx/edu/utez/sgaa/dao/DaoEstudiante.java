...
public class DaoEstudiante {
    ...
    public int RegistrarEstudiante(Estudiante estudiante) throws ClassNotFoundException {
        String INSERT_USERS_SQL = "INSERT INTO estudiantes (matricula, contraseña, nombre, apellido, grupo, cuatrimestre, correoElectronico, estatus) VALUES (?, ?, ?, ?, ?, ?, ?, 1);";
        int result = 0;
    ...
    public List<Estudiante> listarEstudiantes() {
        ...
        try (Connection connection = DriverManager.getConnection(JDBC_URL, JDBC_USER, JDBC_PASSWORD);
            ...
            while (rs.next()) {
                ...
                estudiante.setEstatus(rs.getInt("estatus"));
